...
namespace ShikimoriSharp.Information
{
    public class People : ApiBase
    {
        ...
        public class Person
        {
            ...
            [JsonProperty("groupped_roles")] public object[] GrouppedRoles { get; set; }

            [JsonProperty("roles")] public object[] Roles { get; set; }

            [JsonProperty("works")] public object[] Works { get; set; }

            [JsonProperty("thread_id")] public object ThreadId { get; set; }
